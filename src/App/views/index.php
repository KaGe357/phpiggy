                    ...
                    <td class="p-4 text-sm text-gray-600">
                        <?php foreach ($transaction['receipts'] as $receipt) : ?>
                            ...
                            <div class="inline-block relative cursor-pointer">
                                <a href="/transaction/<?php echo e($transaction['id']); ?>/receipt/<?php echo e($transaction['id']); ?>">
                                ...
                                <form action="/transaction/<?php echo e($transaction['id']); ?>/receipt/<?php echo e($transaction['id']); ?>" method="POST">
