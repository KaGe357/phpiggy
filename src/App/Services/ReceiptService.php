...
class ReceiptService
{
    ...
    public function validateFile(?array $file)
    {
        ...
        if (!preg_match('/^[A-Za-z0-9\s._-]+$/u', $originalFileName)) {
            throw new ValidationException([
        ...
        if (!in_array(strtolower($clientMimeType), $allowedMimeTypes) || !in_array(strtolower($fileExtension), $allowedExtensions)) {
            throw new ValidationException([
                'receipt' => ['Invalid file type or extension']
            ]);
        }
    }
